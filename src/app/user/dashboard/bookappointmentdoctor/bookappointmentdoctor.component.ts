...
@Component({
  ...
  selector: 'app-bookappointmentdoctor',
  templateUrl: './bookappointmentdoctor.component.html',
  styleUrls: ['./bookappointmentdoctor.component.sass']
 
})
export class BookappointmentdoctorComponent implements OnInit {

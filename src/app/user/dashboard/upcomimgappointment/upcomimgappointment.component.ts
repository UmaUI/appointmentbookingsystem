...
@Component({
  selector: 'app-upcomimgappointment',
  templateUrl: './upcomimgappointment.component.html',
  styleUrls: ['./upcomimgappointment.component.sass']
})
export class UpcomimgappointmentComponent implements OnInit {

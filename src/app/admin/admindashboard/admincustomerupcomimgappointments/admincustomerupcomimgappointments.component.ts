...
@Component({
  selector: 'app-admincustomerupcomimgappointments',
  templateUrl: './admincustomerupcomimgappointments.component.html',
  styleUrls: ['./admincustomerupcomimgappointments.component.sass']
})
export class AdmincustomerupcomimgappointmentsComponent implements OnInit {

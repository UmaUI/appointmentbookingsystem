...
@Component({
  selector: 'app-admineditdoctorconsulttimeenable',
  templateUrl: './admineditdoctorconsulttimeenable.component.html',
  styleUrls: ['./admineditdoctorconsulttimeenable.component.sass']
})
export class AdmineditdoctorconsulttimeenableComponent implements OnInit {

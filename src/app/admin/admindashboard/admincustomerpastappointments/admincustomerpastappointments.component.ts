...
@Component({
  selector: 'app-admincustomerpastappointments',
  templateUrl: './admincustomerpastappointments.component.html',
  styleUrls: ['./admincustomerpastappointments.component.sass']
})
export class AdmincustomerpastappointmentsComponent implements OnInit {

...
@Component({
  selector: 'app-adminviewappointmentslist',
  templateUrl: './adminviewappointmentslist.component.html',
  styleUrls: ['./adminviewappointmentslist.component.sass']
})
export class AdminviewappointmentslistComponent implements OnInit {

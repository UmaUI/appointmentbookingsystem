...
@Component({
  selector: 'app-admineditdoctormobileno',
  templateUrl: './admineditdoctormobileno.component.html',
  styleUrls: ['./admineditdoctormobileno.component.sass']
})
export class AdmineditdoctormobilenoComponent implements OnInit {

...
@Component({
  selector: 'app-admineditdoctorprofileimg',
  templateUrl: './admineditdoctorprofileimg.component.html',
  styleUrls: ['./admineditdoctorprofileimg.component.sass']
})
export class AdmineditdoctorprofileimgComponent implements OnInit {
  ...
  onUpdateSubmit(doctor){
   ...
   var _doctor = {
    _id:this.id,
     ...
     {
     //Update User
     this.authService.updateProfileimgDoctor(_doctor).subscribe(data =>{

...
@Component({
  selector: 'app-adminupcomingappointmentsdetails',
  templateUrl: './adminupcomingappointmentsdetails.component.html',
  styleUrls: ['./adminupcomingappointmentsdetails.component.sass']
})
export class AdminupcomingappointmentsdetailsComponent implements OnInit {

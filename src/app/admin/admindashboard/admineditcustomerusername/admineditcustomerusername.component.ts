...
@Component({
  selector: 'app-admineditcustomerusername',
  templateUrl: './admineditcustomerusername.component.html',
  styleUrls: ['./admineditcustomerusername.component.sass']
})
export class AdmineditcustomerusernameComponent implements OnInit {
  ...
  onUpdateSubmit(customer){
   ...
   var _customer = {
    _id:this.id,
     ...
     //Update User
     this.authService.updateUsernameCustomer(_customer).subscribe(data =>{

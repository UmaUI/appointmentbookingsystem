...
@Component({
  selector: 'app-admineditdoctorconsulttime',
  templateUrl: './admineditdoctorconsulttime.component.html',
  styleUrls: ['./admineditdoctorconsulttime.component.sass']
})
export class AdmineditdoctorconsulttimeComponent implements OnInit {
